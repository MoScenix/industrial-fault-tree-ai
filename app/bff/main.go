...
import (
	...
	"github.com/MoScenix/industrial-fault-tree-ai/app/bff/biz/dal"
	"github.com/MoScenix/industrial-fault-tree-ai/app/bff/biz/router"
	"github.com/MoScenix/industrial-fault-tree-ai/app/bff/conf"
	"github.com/MoScenix/industrial-fault-tree-ai/app/bff/infra/rpc"
	"github.com/MoScenix/industrial-fault-tree-ai/app/bff/middleware"
...
func main() {
	...
	godotenv.Load()
	dal.Init()
	mtl.InitMetric(conf.GetConf().Hertz.Service, conf.GetConf().Hertz.MetricsPort, conf.GetConf().Consul.Address)
